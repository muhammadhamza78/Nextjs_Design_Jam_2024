        ...
        <div className="p-[20px] flex flex-wrap md:flex-nowrap items-center gap-10 px-24">
          <div className="flex-1">
            ...
            <div className="relative w-full h-[300px]">
              <Image
                src="/sofa20.svg" // Ensure the path is correct for Next.js
                alt="Product"
                layout="fill" // Fill the container's size
                objectFit="cover" // Maintain aspect ratio
                className="rounded-lg shadow-md"
                priority // Optional: prioritizes loading this image for better performance
              />
            </div>
          </div>
          <div className="flex-1">
