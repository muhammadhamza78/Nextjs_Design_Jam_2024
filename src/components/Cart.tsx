...
//       {/* Heading added here */}
//       <h2 className="text-3xl font-semibold mb-4 text-center">CART</h2>
...
//             <button
//               className="p-1 text-gray-700 border rounded"
...
//       ))}
//       <div className="mt-4">
//         <button className="w-full bg-blue-600 text-white py-2 rounded-lg">Checkout</button>
//       </div>
//     </div>
//   );
// };
